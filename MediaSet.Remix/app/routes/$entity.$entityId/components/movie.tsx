...
import ImageLookupInfo from '~/components/images/image-lookup-info';
      ...
      <div className="h-full mt-4">
        <div className="flex flex-col lg:flex-row lg:gap-3">
          ...
          <div className="lg:basis-4/5">
            ...
            <div className="flex flex-col md:flex-row mb-2 md:mb-0">
              <label htmlFor="runtime" className="basis-2/12 dark:text-slate-400">
                Runtime
              </label>
              <div id="runtime" className="grow">
                {movie.runtime}
              </div>
            </div>
            <div className="flex flex-col md:flex-row mb-2 md:mb-0">
            ...
            <div className="flex flex-col md:flex-row mb-2 md:mb-0">
              <label htmlFor="tvShow" className="basis-2/12 dark:text-slate-400">
                Is TV Show
              </label>
              <div id="tvShow" className="grow">
            ...
            <div className="flex flex-col md:flex-row mb-2 md:mb-0">
              <label htmlFor="studios" className="basis-2/12 dark:text-slate-400">
                Studios
              </label>
