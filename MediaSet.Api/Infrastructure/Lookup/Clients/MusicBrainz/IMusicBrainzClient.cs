...
public interface IMusicBrainzClient
{
    ...
    Task<IReadOnlyList<MusicBrainzRelease>> SearchByEntityPropertiesAsync(IReadOnlyDictionary<string, string> searchParams, CancellationToken cancellationToken);
}
