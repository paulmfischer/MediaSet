...
public interface IOpenLibraryClient
{
    ...
    Task<IReadOnlyList<BookResponse>> SearchByEntityPropertiesAsync(IReadOnlyDictionary<string, string> searchParams, CancellationToken cancellationToken = default);
}
